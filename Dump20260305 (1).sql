...
CREATE TABLE `chuyen_kho` (
  ...
  `MaCHNguon` int DEFAULT NULL COMMENT 'Lưu MaKho nguồn',
  `MaCHDich` int DEFAULT NULL COMMENT 'Lưu MaKho đích',
  `MaSP` int NOT NULL,
  `SoLuong` int NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=383 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lịch sử thao tác hệ thống';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-05 15:02:36
