...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Log phân bổ số lượng sản phẩm vào từng kho con khi nhập';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chitietphieunhap` (`MaPN`, `MaSP`, `DonGiaNhap`, `SoLuong`) VALUES (1,3,50000.00,1),(2,4,35000.00,10),(2,5,90000.00,10),(2,6,70000.00,10),(2,7,100000.00,10),(2,17,58000.00,10),(3,59,88000.00,9),(4,59,105600.00,8),(3,96,95000.00,13);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Chuyển hàng giữa các chi nhánh';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chuyen_kho` VALUES (1,1,2,3,1,'2026-02-02 09:16:14',2,NULL,'2026-02-25 19:17:59','Da_nhan',NULL),(2,1,2,4,1,'2026-02-02 09:16:14',2,NULL,NULL,'Cho_duyet',NULL),(3,1,2,1,2,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL),(4,1,2,2,1,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL),(5,1,2,3,1,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL),(6,1,2,4,1,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Công nợ phải trả NCC';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `kho_con` VALUES (1,1,'Kho 1',5000,1,'Tầng trệt, phía sau quầy',1,'Kho chính, ưu tiên nhập đầu tiên','2026-03-04 19:52:25'),(2,1,'Kho 2',3000,2,'Tầng 2',1,'Kho phụ, nhận hàng khi Kho 1 đầy','2026-03-04 19:52:25'),(3,2,'Kho 1',5000,1,'Tầng trệt',1,'Kho chính','2026-03-04 19:52:25'),(4,2,'Kho 2',3000,2,'Phía sau',1,'Kho phụ','2026-03-04 19:52:25'),(5,3,'Kho 1',5000,1,'Tầng trệt',1,'Kho chính','2026-03-04 19:52:25'),(6,3,'Kho 2',3000,2,'Phía sau',1,'Kho phụ','2026-03-04 19:52:25');
...
) ENGINE=InnoDB AUTO_INCREMENT=364 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lịch sử thao tác hệ thống';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Phân quyền CRUD chi tiết';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `taikhoan` VALUES (1,'admin','$2a$10$SdhH9jA08X5/FOIoAnr5TOv8HOsOXvERzDU00fONOhG7zkPx2SDXW','admin@bansach.vn',1,1,'2026-01-23 09:50:57'),(2,'quanly01','$2a$10$RZwm4ORbMGTVh77MlStrdeYXW2eIiGP94LHkGC0KbLWclhL7p15fm','quanly01@bansach.vn',1,2,'2026-01-23 09:50:57'),(3,'thungan01','$2a$10$RZwm4ORbMGTVh77MlStrdeYXW2eIiGP94LHkGC0KbLWclhL7p15fm','thungan01@bansach.vn',1,3,'2026-01-23 09:50:57'),(4,'kho01','$2a$10$RZwm4ORbMGTVh77MlStrdeYXW2eIiGP94LHkGC0KbLWclhL7p15fm','kho01@bansach.vn',1,4,'2026-01-23 09:50:57'),(5,'hr01','$2a$10$RZwm4ORbMGTVh77MlStrdeYXW2eIiGP94LHkGC0KbLWclhL7p15fm','hr01@bansach.vn',1,5,'2026-01-23 09:50:57');
...
) ENGINE=InnoDB AUTO_INCREMENT=612 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tồn kho từng chi nhánh';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-04 20:05:28
