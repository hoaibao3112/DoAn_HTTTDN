...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { to: '/admin/barcode-generator', icon: 'qr_code_scanner', text: 'Tạo mã vạch', permissionId: FEATURES.POS },
    ...
    { to: '/admin/sub-warehouses', icon: 'warehouse', text: 'Quản lý kho con', permissionId: FEATURES.STOCK },
