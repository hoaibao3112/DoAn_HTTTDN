...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Log phân bổ số lượng sản phẩm vào từng kho con khi nhập';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chitiet_phanbokho` VALUES (1,5,2,3,4,'2026-03-05 06:32:42'),(2,6,6,3,3,'2026-03-05 06:50:35'),(3,6,8,3,15,'2026-03-05 06:50:35');
...
INSERT INTO `chitietphieunhap` (`MaPN`, `MaSP`, `DonGiaNhap`, `SoLuong`) VALUES (5,2,65000.00,4),(1,3,50000.00,1),(2,4,35000.00,10),(2,5,90000.00,10),(2,6,70000.00,10),(6,6,70000.00,3),(2,7,100000.00,10),(6,8,120000.00,15),(2,17,58000.00,10),(3,59,88000.00,9),(4,59,105600.00,8),(3,96,95000.00,13);
...
INSERT INTO `chuyen_kho` VALUES (1,1,2,3,1,'2026-02-02 09:16:14',2,NULL,'2026-02-25 19:17:59','Da_nhan',NULL),(2,1,2,4,1,'2026-02-02 09:16:14',2,NULL,NULL,'Cho_duyet',NULL),(3,1,2,1,2,'2026-03-04 19:31:43',2,2,'2026-03-04 22:48:59','Da_nhan',NULL),(4,1,2,2,1,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL),(5,1,2,3,1,'2026-03-04 19:31:43',2,NULL,NULL,'Cho_duyet',NULL),(6,1,2,4,1,'2026-03-04 19:31:43',2,2,'2026-03-04 22:39:13','Da_nhan',NULL),(7,1,2,1,12,'2026-03-05 06:24:23',2,2,'2026-03-05 06:24:42','Da_nhan',NULL),(8,1,2,2,1,'2026-03-05 06:24:23',2,1,'2026-03-05 07:27:41','Da_nhan',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Công nợ phải trả NCC';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=378 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Lịch sử thao tác hệ thống';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=619 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tồn kho từng chi nhánh';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-05  9:44:34
